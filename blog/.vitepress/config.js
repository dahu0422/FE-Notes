    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: "new 操作符", link: "/interview/js/new操作符.md" },
          {
            ...
            link: "/interview/js/call、apply、bind的区别.md",
          },
          { text: "原型、原型链", link: "/interview/js/原型与原型链.md" },
          {
            text: "执行上下文、执行栈",
            link: "/interview/js/执行上下文与执行栈.md",
          },
          {
            text: "作用域、作用域链",
            link: "/interview/js/作用域与作用域链.md",
          },
          { text: "this 指向", link: "/interview/js/this指向.md" },
          { text: "闭包", link: "/interview/js/闭包.md" },
          {
            text: "DOM 文档对象模型",
            link: "/interview/js/DOM文档对象模型.md",
          },
          {
            text: "DOM 事件注册和移除",
            link: "/interview/js/DOM事件注册和移除.md",
          },
          {
            text: "DOM 事件传播机制",
            link: "/interview/js/DOM事件传播机制.md",
          },
          {
            text: "ES6",
      ...
      },
      {
        ...
        items: [
          ...
          { text: "HTTP协议版本", link: "/interview/network/HTTP协议版本.md" },
